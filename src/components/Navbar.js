  ...
  return (
    <header className="bg-white shadow p-4 flex justify-between items-center px-[150px]">
      ...
      <nav className="flex items-center gap-5 text-sm">
        ...
        <Link to="/watches" className="text-blue-600 font-medium">
          Watches
        </Link>
        ...
        <Link to="/checkout" className="text-blue-600 font-medium">
          Checkout
        </Link>
        ...
        {/* ✅ Bills list */}
        <Link to="/bill" className="text-blue-600 font-medium">
          Bills
        </Link>
